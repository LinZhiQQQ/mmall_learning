...
public class ProductServiceImpl implements IProductService {
    ...
    public ServerResponse<ProductDetailVo> manageProductDetail(Integer productId) {
        ...
        ProductDetailVo productDetailVo = assembleOriductDetailVo(product);
        return ServerResponse.createBySuccess(productDetailVo);
    }

    private ProductDetailVo assembleOriductDetailVo(Product product){
        ...
        // imageHost
        productDetailVo.setImageHost(PropertiesUtil.getProperty(Const.FTP_SERVER_HTTP_PREFIX, "http://img.imooc.com/"));
        // parentCategoryId
